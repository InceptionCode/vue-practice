  ...
  <div>
    ...
    <ul>
      <li v-for="contact in contactList" :key="contact.id">
        ...
        <span class="edit-button" @click="commitEdit(contact.id)">edit</span>
        <i class="fa-times" @click="deleteThisContact(contact.id)">
          x
        </i>
      </li>
    </ul>
...
export default {
  ...
  methods: {
    ...
    commitEdit(editID) {
      ...
      let favoritesContacts = favoritesList.filter(
